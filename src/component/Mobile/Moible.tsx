    ...
    <div className="ContentMobile">
      <div className="SecMobile1">
        ...
        <div className="contentIcons">
          ...
          <a href="https://firebasestorage.googleapis.com/v0/b/blog-46e71.appspot.com/o/CVweb_developer_RomarioAriza.pdf?alt=media&token=785f2e00-422c-4840-9bcf-81fa6d793422">
        ...
        <div className="contentProyectsFront">
          ...
          <div className="contentProyec">
            ...
            <div className="contentText">
              ...
              restaurantes en el backend. La API permitirá la administración de
              ...
              acciones, como realizar pedidos y dejar comentarios.
              <br />
              ...
              Asimismo, se ha aplicado el manejo de errores para garantizar una
              experiencia fluida y confiable. Las variables de entorno han sido
              utilizadas para configurar aspectos específicos de la aplicación
              según el entorno de despliegue. Por último, se ha implementado un
              sistema de autenticación y niveles de acceso para garantizar la
          ...
          <div className="contentProyec">
            ...
            <div className="contentText">
              El presente proyecto tiene como finalidad desarrollar una API,
              Este proyecto fue creado para aplicarlo a un taller de bicicletas,
              donde los usuarios pueden apartar sus reparaciones y cancelarlas
              si se demoran. Los empleados pueden marcar una reparación como
              completada. La aplicación permite iniciar sesión a través de un
              token y se ha hecho uso del framework de express. También se
              empleó una base de datos MySQL con las relaciones
