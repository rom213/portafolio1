        ...
        <div className="headerAbout">
          ...
          <div className="contentProyectsFront">
            ...
            <div className="contentProyec">
              ...
              <div className="contentText">
                En este proyecto se desarrollo una API
                ...
                la calidad del servicio en los restaurantes. Además, se brinda
                la funcionalidad de crear usuarios, lo cual les otorga
                diversas acciones, como realizar pedidos y dejar comentarios.
                <br />
                Tecnologías utilizadas: en la implementación de este proyecto,
